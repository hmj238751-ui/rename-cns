...
- 监听论文下载，并在文件保存前建议新文件名。
- 读取论文网页公开的标题、期刊、年份、DOI 等信息。
...
1. 打开 GitHub 仓库：
   <https://github.com/hmj238751-ui/rename-cns>
2. 点击绿色的 **Code** 按钮，再点击 **Download ZIP**。
3. 打开电脑的“下载”文件夹，找到 `rename-cns-main.zip`。
4. 双击压缩包进行解压。
5. 将解压出的 `rename-cns-main` 文件夹移动到桌面或“文档”文件夹。
6. 不要删除或随意移动这个文件夹，浏览器扩展需要持续使用它。
7. 在 Chrome 地址栏打开：
...
8. 打开右上角的“开发者模式”。
9. 点击“加载已解压的扩展”。
10. 选择刚才解压并保存好的 `rename-cns-main` 文件夹。
